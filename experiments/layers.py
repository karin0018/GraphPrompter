...
from models.supernode_propagation_layers import (
    ...
    BgGraphToSupernodePropagatorSAGPool,
)
from transformers import GPT2Model, GPT2Config
from models.nodeformer import *

def get_module_list(module_string, emb_dim, edge_attr_dim, input_dim, dropout, reset_after_layer, attention_mask_scheme, has_final_back, msg_pos_only, batch_norm_metagraph=True, batch_norm_encoder=True, gnn_use_relu=False,use_edge_loss=True, edge_fliter_feat_dim=1536):
    '''
        ...
        if layer[0] == "E":
            ...
            module_list.append(
                get_model(add_to_dim_in=0,
                          ...
                          gnn_type="denosingSAGE",
                          edge_attr_dim=edge_attr_dim,
                          edge_fliter_feat_dim=edge_fliter_feat_dim,
                          dropout = dropout,
            ...
            # Up : aggregation from background graph to supernode
            module_list.append(
                BgGraphToSupernodePropagatorSAGPool(emb_dim)
            )
        elif layer[0] == "U":
            # Up : aggregation from background graph to supernode
            module_list.append(
